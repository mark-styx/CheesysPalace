...
fetch( 'http://10.0.0.47:5000/check_devices')
    ...
    .then( devices => {
        ...
        for (var deviceType in devices) {
            ...
            for (var deviceAliasKey in devices[deviceType]) {
                ...
                btnOn.value = 'http://10.0.0.47:5000/device_action/' + deviceAlias + '/power/1'
                btnOff.value = 'http://10.0.0.47:5000/device_action/' + deviceAlias + '/power/0' 
